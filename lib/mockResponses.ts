...
const observerResponses = [
  ...
  '結局、あなたが一番怖いのって何だろうね。',
  'どうなったら「少しマシ」になる気がする？',
  '面白いね。その感情、いつ頃から持ってると思う？',
  'その状況を少し外から見ると、どう見える？',
  '「変わりたい」と「変わるのが怖い」が同時にある感じ、しない？',
  'それって、本当に自分が望んでることかな。',
  '今感じてることに、名前をつけるとしたら何かな。',
  '誰かの期待に応えようとしてる部分、ありそう？',
  'その繰り返しの中に、何か共通点があると思う？',
  '今の自分に必要なのって、答えじゃなくて問いかけかもしれないね。',
  '10年後の自分が今の自分を見たら、何て言うと思う？',
]
